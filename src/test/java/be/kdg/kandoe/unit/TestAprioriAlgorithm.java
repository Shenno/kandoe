...
/*        assertEquals("The 1st frequent itemsetlist must be correct", "[card1]", frequentItemsetList.get(0).toString());
        ...
        assertEquals("The 4th frequent itemsetlist must be correct", "[card1, card5]", frequentItemsetList.get(3).toString());
        assertEquals("The 5th frequent itemsetlist must be correct", "[card2, card3]", frequentItemsetList.get(4).toString());
        assertEquals("The 6th frequent itemsetlist must be correct", "[card4, card2]", frequentItemsetList.get(5).toString());
        assertEquals("The 7th frequent itemsetlist must be correct", "[card4, card3]", frequentItemsetList.get(6).toString());
        assertEquals("The 8th frequent itemsetlist must be correct", "[card4, card5]", frequentItemsetList.get(7).toString());
        assertEquals("The 9th frequent itemsetlist must be correct", "[card1, card2, card3]", frequentItemsetList.get(8).toString());
        assertEquals("The 10th frequent itemsetlist must be correct", "[card4, card1, card2]", frequentItemsetList.get(9).toString());
        assertEquals("The 11th frequent itemsetlist must be correct", "[card4, card1, card3]", frequentItemsetList.get(10).toString());
        assertEquals("The 12th frequent itemsetlist must be correct", "[card4, card1, card5]", frequentItemsetList.get(11).toString());
        assertEquals("The 13th frequent itemsetlist must be correct", "[card4, card2, card3]", frequentItemsetList.get(12).toString());
    }
}