System.register(['angular2/core', 'angular2/router', "./components/cirkelsessie.component", "./components/createTheme.component", "./components/editTheme.component", "./components/detailTheme.component", "./components/createOrganisation.component.ts"], function(exports_1) {
    ...
    var core_1, router_1, cirkelsessie_component_1, createTheme_component_1, editTheme_component_1, detailTheme_component_1, createOrganisation_component_ts_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (createOrganisation_component_ts_1_1) {
                createOrganisation_component_ts_1 = createOrganisation_component_ts_1_1;
            }],
        execute: function() {
            AppComponent = (function () {
                ...
                AppComponent = __decorate([
                    ...
                    router_1.RouteConfig([
                        ...
                        { path: '/createOrganisation', name: 'CreateOrganisation', component: createOrganisation_component_ts_1.CreateOrganisationComponent }
                    ]), 
